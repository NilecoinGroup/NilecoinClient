...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nilecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][3] = {
    {"nilechain.info", "45.77.87.29"},
	{"nil-api.com", "45.76.6.223"},//52.4.67.185
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][3] = {
    {"nilechain.info", "ec2-52-205-49-51.compute-1.amazonaws.com"},   
	{NULL, NULL},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nilecoin is probably already running."), addrBind.ToString().c_str());
        else
