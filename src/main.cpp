...
#if defined(NDEBUG)
# error "Nilecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x1f962b90e4f2ef7e07c9361786f1e3623078cb87a469fe1a7b74bd5d24ffb6cb");

static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Nilecoin: starting difficulty is 1, Litecoin is 1 / 2^12
...
const string strMessageMagic = "Nilecoin Signed Message:\n";
...
// Set Pool Mining Address Get Rewards
CScript POOL_MINING_REWARDS;
int checkFirstAddressReward = 0;
...
{
    // Nilecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
	int64 startReward = 64;
    int64 nSubsidy = startReward * COIN;
	int64 totalBlockInYear = 10 * 24 * 365; //1 year have 10 x 24 x 365 blocks, 1 block in 6 minutes
	int64 totalBlockInMonth = totalBlockInYear / 12; // Total blocks in 1 month
    if(nHeight == 1)
    {
        nSubsidy = 20000000 * COIN;
    }
	else if(nHeight == 5467)
    {
        nSubsidy = 50000000 * COIN;
    }
	else if(nHeight>=totalBlockInYear)
	{
		int64 decReward= 1;
		for(int i=1;i<=nHeight/totalBlockInYear;i++)
		{
			decReward = 2 * decReward;
		}
		int64 nextReward = startReward/decReward;
		if(nextReward>0.0001)
		{
			nSubsidy = nextReward * COIN;
		}
		else
		{
    ...
    //nSubsidy >>= (nHeight / 840000); // Nilecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Nilecoin: 2 days
static const int64 nTargetSpacing = 6 * 60; // Nilecoin: 6 minutes.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Nilecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
void static InvalidChainFound(CBlockIndex* pindexNew)
{
    ...
    printf("InvalidChainFound: invalid block=%s  height=%d  log2_work=%.8g  date=%d\n",
      pindexNew->GetBlockHash().ToString().c_str(), pindexNew->nHeight,
      log(pindexNew->nChainWork.getdouble())/log(2.0), pindexNew->GetBlockTime());
    printf("InvalidChainFound:  current best=%s  height=%d  log2_work=%.8g  date=%d\n",
...
bool SetBestChain(CValidationState &state, CBlockIndex* pindexNew)
{
    ...
    nTransactionsUpdated++;
    printf("SetBestChain: new best=%s  height=%d  log2_work=%.8g  tx=%lu  date=%d progress=%f\n",
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Nilecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool static LoadBlockIndexDB()
{
    ...
    printf("LoadBlockIndexDB(): hashBestChain=%s  height=%d date=%d\n",
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1f962b90e4f2ef7e07c9361786f1e3623078cb87a469fe1a7b74bd5d24ffb6cb");
		
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1526627880; //1525921445; //1525219201; //1524528001; //1415210670; //1514764801;
        block.nBits    = 0x1e0ffff0;// 0x1d00ffff; //0x1e0ffff0;
        block.nNonce   = 33779; //3064; //535191; //2126572; // 2167216; // 2110551;
		...
		//0xd010ddcc6651af0e28e50ee36096e438b7974da9d58f1be95a968b180756a0c8
        if (true && block.GetHash() != hashGenesisBlock)
        {
            ...
            loop
            {
                ...
                {
                    printf("block.nTime = %u / nonce %08X: hash = %s (target = %s)\n",block.nTime, block.nNonce, thash.ToString().c_str(), hashTarget.ToString().c_str());
                }
                ++block.nNonce;
                if (block.nNonce == 0)
                {
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Nilecoin: increase each by adding 2 to bitcoin's value.
...
CBlockTemplate* CreateNewBlockWithKey(CReserveKey& reservekey)
{
	...
	if(checkFirstAddressReward == 0)
	{
		checkFirstAddressReward = 1;
		POOL_MINING_REWARDS = scriptPubKey;
	}
	scriptPubKey = POOL_MINING_REWARDS;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("NilecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("NilecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static NilecoinMiner(CWallet *pwallet)
{
    printf("NilecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("nilecoin-miner");
    ...
    try { loop {
        ...
        printf("Running NilecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("NilecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&NilecoinMiner, pwallet));
}
